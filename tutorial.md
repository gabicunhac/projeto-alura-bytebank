...
Ter uma conta é o primeiro passo para inciar a gestão das suas finanças com os serviços da Bytebank.
A partir dela, você poderá acessar os produtos de investimento disponíveis, realizar transações sem taxas e solicitar um cartão com função dupla de crédito ou débito.
...
Caso você seja um correntista com 16 a 18 anos, a criação da conta deve ser realizada por seu responsável financeiro.
Uma vez concluídas as etapas, a titularidade é transferida e você pode assumar a gestão da conta pelo app ou site da Bytebank.
...
Ao final do cadastro, um link de ativação será enviado ao seu e-mail.
Basta acessá-lo e você será redirecionado para a página inicial da Bytebank:
...
O formulário de perfil de investidor é composto de perguntas que ajudam o banco a conhecer a sua relação com investimentos e, principalmente, ao risco envolvido dependendo do produto adquirido na sua carteira de investimentos.
De acordo com a classificação do Banco Central do Brasil (BACEN), é possível ter 3 perfis:
